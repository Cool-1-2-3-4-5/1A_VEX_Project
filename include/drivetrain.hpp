...
public:
    Drivetrain(char left_Port, char right_Port, char bumper_Port) : left_(left_Port, false),
    ...
    bool bumpMove(float dist_to_middle)
    {
        ...
        // Brain.Screen.printAt(10, 20, "Difference: %.1f mm", difference);
        ...
        {
            // Brain.Screen.printAt(10, 40, "Bumper hit first!");
